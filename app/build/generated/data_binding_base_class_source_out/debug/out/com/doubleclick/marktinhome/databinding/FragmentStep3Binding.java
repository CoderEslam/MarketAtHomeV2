...
public final class FragmentStep3Binding implements ViewBinding {
  ...
  @NonNull
  public final ImageView selectCover;
  ...
  private FragmentStep3Binding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull Button next, @NonNull CircularProgressIndicator progressBar,
      @NonNull ImageView selectCover, @NonNull TextView skip, @NonNull TextView textView) {
  ...
  public static FragmentStep3Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_step_3, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentStep3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.selectCover;
      ImageView selectCover = ViewBindings.findChildViewById(rootView, id);
      if (selectCover == null) {
        break missingId;
      }
      ...
      return new FragmentStep3Binding((ConstraintLayout) rootView, main, next, progressBar,
          selectCover, skip, textView);
    }
