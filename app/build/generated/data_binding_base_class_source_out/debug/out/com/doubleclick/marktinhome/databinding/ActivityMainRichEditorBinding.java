...
public final class ActivityMainRichEditorBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainRichEditorBinding(@NonNull FrameLayout rootView,
      @NonNull FrameLayout flAction, @NonNull FrameLayout flContainer,
      @NonNull HorizontalScrollView hsvActionBar, @NonNull ImageView ivAction,
      @NonNull ImageView ivActionInsertImage, @NonNull ImageView ivActionInsertLink,
      @NonNull ImageView ivActionLineHeight, @NonNull ImageView ivActionRedo,
      @NonNull ImageView ivActionTable, @NonNull ImageView ivActionTxtBgColor,
      @NonNull ImageView ivActionTxtColor, @NonNull ImageView ivActionUndo,
      @NonNull ImageView ivGetHtml, @NonNull LinearLayout llActionBarContainer,
  ...
  @NonNull
  public static ActivityMainRichEditorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainRichEditorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_rich_editor, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainRichEditorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout flContainer = (FrameLayout) rootView;
      ...
      return new ActivityMainRichEditorBinding((FrameLayout) rootView, flAction, flContainer,
