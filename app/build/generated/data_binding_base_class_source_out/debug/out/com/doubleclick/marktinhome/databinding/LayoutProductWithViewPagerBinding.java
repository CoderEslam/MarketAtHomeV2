...
public final class LayoutProductWithViewPagerBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutProductWithViewPagerBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static LayoutProductWithViewPagerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutProductWithViewPagerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_product_with_view_pager, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutProductWithViewPagerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutProductWithViewPagerBinding((ConstraintLayout) rootView,
          bannerSlierViewPager, cardView, description, productLastPrice, productName, productPrice,
          ratingBar, trademark);
    }
