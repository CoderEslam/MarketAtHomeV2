...
public final class DialogColorpickerColorpickerviewSkydovesBinding implements ViewBinding {
  ...
  private DialogColorpickerColorpickerviewSkydovesBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static DialogColorpickerColorpickerviewSkydovesBinding inflate(
  ...
  public static DialogColorpickerColorpickerviewSkydovesBinding inflate(
    ...
    View root = inflater.inflate(R.layout.dialog_colorpicker_colorpickerview_skydoves, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogColorpickerColorpickerviewSkydovesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogColorpickerColorpickerviewSkydovesBinding((ScrollView) rootView,
          alphaSlideBar, alphaSlideBarFrame, brightnessSlideBar, brightnessSlideBarFrame,
          colorPickerView, colorPickerViewFrame, spaceBottom);
    }
