...
public final class TableRowBinding implements ViewBinding {
  ...
  private TableRowBinding(@NonNull LinearLayout rootView) {
  ...
  public static TableRowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.table_row, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TableRowBinding bind(@NonNull View rootView) {
    if (rootView == null) {
