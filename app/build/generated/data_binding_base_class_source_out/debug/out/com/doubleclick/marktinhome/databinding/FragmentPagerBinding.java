...
public final class FragmentPagerBinding implements ViewBinding {
  ...
  private FragmentPagerBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView products) {
  ...
  public static FragmentPagerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPagerBinding((ConstraintLayout) rootView, products);
    }
